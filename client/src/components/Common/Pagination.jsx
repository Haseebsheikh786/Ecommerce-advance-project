    ...
    <div className="flex items-center justify-between border-t border-gray-200 bg-black px-4 py-3 sm:px-6">
      <div className="flex flex-1 justify-between sm:hidden">
        <div
          ...
          className="relative inline-flex items-center rounded-md border border-gray-300 bg-black px-4 py-2 text-sm font-medium text-white-700 hover:bg-white-50"
        >
          Previous
        </div>
        <div
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          ...
          >
            ...
            <div
              onClick={(e) => handlePage(page < totalPages ? page + 1 : page)}
              className="relative inline-flex items-center rounded-r-md px-2 py-2 text-white-400 ring-1 ring-inset ring-white-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
            >
